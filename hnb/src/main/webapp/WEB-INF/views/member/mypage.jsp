...
<script type="text/javascript">
	...
	var LoginMember = {
			...
			style : function(){
				$('.mainView').css('background-color','white');
				$('#tab_detail').css('width','80%').css('margin','auto').css('border','1px solid black');
				$('td').add('th').css('text-align','center').css('border','1px solid black');
				$('tr').add('th').add('td').css('float','center').css('border','1px solid black');
