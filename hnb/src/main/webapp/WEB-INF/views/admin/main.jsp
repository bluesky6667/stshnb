...
<script>
$(function() {
	Admin2.memberList(context+'/admin/memberList/1');
});
 var Admin2 = {
		 memberList : function(url) {
			 $.getJSON(url,function(data) {
					...
					if (startPage != 1) {
						pagination += '<a href="'+context+'/admin/memberList/1">'
					...
					for (var i = startPage; i <= lastPage; i++) {
						if (i==pageNo) {
							pagination += '<font style="color: yellow;font-size: 18px">'
							+i
							+'</font>';
						} else {
							pagination += '<a href="${context}/admin/memberList/'+i+'">'
							+'<font>'
							+i
							+'</font>'
							+'</a>';
